...
#This version of the choropleth map will show the show the country name and confirmed cases once the user hovers over the country.
...
#once the user hovers over a country it will display the confirmed covid cases of that particular country only.
